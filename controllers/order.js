...
export const getAllOrders = async (req, res, next) => {
    ...
    try {
        ...
        //     $or:
        //         [{ orderAdress: txt }, { ordererId: txt }]
        // }).select('orderAdress ordererId ')
...
export const addOrder = async (req, res) => {
    let { orderDate, getOrderDate,  orderAdress, products,orderAmount ,ordererId} = req.body;
    if (!orderAdress)
        ...
        // console.log(errors)
    try {
        let newOrder = new orderModel({ orderDate, getOrderDate,  orderAdress, products,orderAmount,ordererId:req.user._id
        });
       let v= await newOrder.save();
        return res.json(v)
    }
    catch (err) {
        console.log(err)
